...
<div class="form-comment" style="margin-right:10%">
	{{Form::open(array("route"=>array('blog.post.edit', $blog->id),"class"=>"form-horizontal",'files'=>true))}}
	    ...
	    <div class="form-group">
	        ...
	        ?>
	        	<img src="{{asset('public/img/blogs').'/'.$image}}" class="img-rounded" alt="Cinque Terre" width="304" height="236" id="blah">
	        </div>
	    </div>
	     <div class="form-group">
	        	{{Form::label('lblDescript',"Description", array("class"=>"col-sm-2 control-label"))}}
	        <div class="col-sm-10">
	        	{{Form::textarea('description',$blog->description, array('class'=>'form-control',"rows"=>6, "id"=>'editor'))}}
	        </div>
	    </div>
	    <div class="form-group">
