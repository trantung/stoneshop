...
<div class="form-comment" style="margin-right:10%">
	{{Form::open(array("route"=>array('product.post.create'),"class"=>"form-horizontal",'files'=>true))}}
	    ...
	    <div class="form-group">
	        {{Form::label('lblLast',"Last", array("class"=>"col-sm-2 control-label"))}}
	        <div class="col-sm-10">
	        	{{Form::number('last',"", array('class'=>'form-control',"rows"=>6))}}
	        </div>
	    </div>
	    <div class="form-group">
	        {{Form::label('lblLong',"Long", array("class"=>"col-sm-2 control-label"))}}
	        <div class="col-sm-10">
	        	{{Form::number('long',"", array('class'=>'form-control',"rows"=>6))}}
	        </div>
	    </div>
	    <div class="form-group">
